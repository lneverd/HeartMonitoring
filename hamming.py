...
# 计算截止频率
cutoff_freq = 2 * center_freq / sample_rate

# 生成汉明窗
window = np.hamming(128)

# # 生成带通滤波器系数
# filter_coeffs = firwin(128, \[cutoff_freq - bandwidth/2, cutoff_freq + bandwidth/2\], window=window)
#
# # 应用滤波器
# filtered_signal = lfilter(filter_coeffs, 1, input_signal)